module github.com/MitchellGerdisch/pulumi-megaport/provider
...
require (
	...
	// MITCHSTART
	// github pulumi go.mod example: github.com/integrations/terraform-provider-github/v5 v5.33.0
	// which is referencing: https://github.com/integrations/terraform-provider-github
	// the megaport provider is here: https://github.com/megaport/terraform-provider-megaport
	// and the megaport provider go.mod references tf sdk 1.9.1
