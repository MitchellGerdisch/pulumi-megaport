...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `megaport` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-megaport
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-megaport/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-megaport/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-megaport_darwin_amd64_v1
│   └── pulumi-resource-megaport
├── pulumi-megaport_darwin_arm64
│   └── pulumi-resource-megaport
├── pulumi-megaport_linux_amd64_v1
│   └── pulumi-resource-megaport
├── pulumi-megaport_linux_arm64
│   └── pulumi-resource-megaport
├── pulumi-megaport_windows_amd64_v1
│   └── pulumi-resource-megaport.exe
└── pulumi-megaport_windows_arm64
    └── pulumi-resource-megaport.exe
```
